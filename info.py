...
API_ID = int(environ.get('API_ID', '28597362'))
API_HASH = environ.get('API_HASH', '594f16e2cf9a6173bdf7a1cca942d94c')
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7846681671').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002364715269').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002327381886'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002327381886'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002327381886'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002327381886'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1001652965240')  # Channel/Group ID for force sub (make sure bot is admin)
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001652965240').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://skbots002:skbots002@skbots0.6umrd.mongodb.net/?retryWrites=true&w=majority&appName=Skbots0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://skbots002:skbots002@skbots0.6umrd.mongodb.net/?retryWrites=true&w=majority&appName=Skbots0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Skbots0")
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002327381886'))  # Log channel id (make sure bot is admin)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+hgwdAA7AzKk2YzU1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Streamplax')
OWNER_LNK = environ.get('OWNER_LNK', 't.me/Sk00ai')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/Streamplax')
OWNERID = int(os.environ.get('OWNERID', '7846681671'))  # Replace with the actual admin ID
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+hgwdAA7AzKk2YzU1')  # Support group link (make sure bot is admin)
